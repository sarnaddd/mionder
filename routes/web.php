...
Route::get('/tracker', [KeluhanController::class, 'historyKeluhan'])->name('tracker')->middleware('auth');
Route::get('/user', [UserController::class, 'index'])->name('user')->middleware('auth');
Route::post('/user/create', [UserController::class, 'addUser'])->name('addUser')->middleware('auth');
...
Route::get('/trackerdoctor', [KeluhanController::class, 'showKeluhanDoctor'])->middleware('auth');
Route::post('/trackerdoctor/{id}', [KeluhanController::class, 'responseDoctor'])->name('response.dokter')->middleware('auth');
